...
sns.regplot(data=df, x='belonging', y='bullying', ci=None)
r,p = pearsonr(df['belonging'], df['bullying'])
...
slope, intercept, r_value, p_value, std_err = linregress(df['belonging'], df['bullying'])
plt.plot(df['belonging'], slope * df['belonging'] + intercept, color='red', label='Regression Line')
